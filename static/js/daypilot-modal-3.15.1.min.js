window.DayPilot = function(t) {
  ...
  ! function(t) {
      if (!t.Searchable) {
          var e = function(t) {
              this.data = [], this.name = null, this.theme = "searchable_default", this.g = !1, this.listZIndex = 1e5, this.onSelect = null, this._ = null, this.I = null, this.M = !1, this.N = null, this.A = null, this.C = [], this.j = null, t = t || {};
              var e = this,
                  i = {
                      selected: {
                          post: function(t) {
          ...
          e.prototype.select = function(t) {
              ...
              n.className = this.theme + "_icon", n.style.position = "absolute", n.style.right = "0", n.style.top = "0", n.style.bottom = "0", n.style.width = "20px", n.addEventListener("mousedown", (function(e) {
                  e.preventDefault(), t.M ? (t.focus(), c()) : (d(), h())
              }));
              ...
              function s() {
                  ...
                  t.data.forEach((function(i) {
                      ...
                      if (-1 !== n.toLowerCase().indexOf(o.value.toLowerCase())) {
                          ...
                          r.className = t.theme + "_list_item", r.innerText = n, r.item = i, i === t._ && (t.I = r), e || (e = r), r.addEventListener("mousedown", (function(t) {
              ...
              function u(e) {
                  ...
                  })), t.I && (t.I.className += " " + t.theme + "_list_item_highlight", !s || (i = t.I, n = a, r = i.getBoundingClientRect(), o = n.getBoundingClientRect(), r.top >= o.top && r.bottom <= o.bottom) || t.I.scrollIntoView())
              }
              ...
              function h() {
                  t.M = !0, o.setAttribute("readonly", "readonly"), o.focus()
              }

              function c() {
                  t.M = !1, o.removeAttribute("readonly"), o.value = "", s()
              }
              return o.type = "text", o.className = this.theme + "_input", o.disabled = this.g, o.addEventListener("click", (function(t) {
                  ...
                  if ("ArrowDown" === i.key)(n = e.C.indexOf(e.I)) + 1 < e.C.length && (e.I = e.C[n + 1]), u();
                  else if ("ArrowUp" === i.key) {
                      var n;
                      (n = e.C.indexOf(e.I)) - 1 >= 0 && (e.I = e.C[n - 1]), u()
                  } else "Enter" === i.key ? t.I ? (i.stopPropagation(), m(t.I)) : (i.stopPropagation(), d(), h()) : "Esc" !== i.key && "Escape" !== i.key || (i.stopPropagation(), d(), h())
              })), this.N = o, this.A = a, this._ || (this._ = this.data[0], this._ && (o.value = this._.name)), i.appendChild(o), i.appendChild(n), i.appendChild(r), i.appendChild(a), i
          }, e.prototype.S = function() {
              this.H(), this._ ? this.N.value = this._.name : (this.N.value = "", this.k(!0))
          }, e.prototype.focus = function() {
              this.M = !0, this.N.setAttribute("readonly", "readonly"), this.N.focus(), this.S()
          }, e.prototype.H = function() {
              this.A.style.display = "none"
          }, e.prototype.k = function(t) {
              if (this.j.value = this.selected ? this.selected.id : null, this._ ? this.N.value = this._.name : this.N.value = "", "function" == typeof this.onSelect) {
                  var e = {
                      control: this,
                      ui: t
                  };
          ...
          this.id = i, this.api = 2, this.isNavigator = !0, this.angularAutoApply = !0, this.weekStarts = "Auto", this.selectMode = "day", this.titleHeight = 30, this.dayHeaderHeight = 30, this.cellWidth = 30, this.cellHeight = 30, this.D = !0, this.selectionStart = null, this.selectionEnd = null, this.selectionDay = (new t.Date).getDatePart(), this.showMonths = 1, this.skipMonths = 1, this.command = "navigate", this.year = (new t.Date).getYear(), this.month = (new t.Date).getMonth() + 1, this.locale = "en-us", this.theme = "navigator_default", this.timeRangeSelectedHandling = "Bind", this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.nav = {}, this.T = function() {
              ...
              for (var _ = 0; _ < 7; _++) {
                  ...
                  for (var M = 0; M < 6; M++) {
                      ...
                      r.cells[_][M] = j, j.day = w, j.x = _, j.y = M, j.isCurrentMonth = N, this.D ? j.className = this.P(N ? "_day" : "_dayother") : j.className = this.P(N ? "day" : "dayother"), n.J(j, "cell"), w.getTime() === c.getTime() && N && this.J(j, "today"), 0 !== w.dayOfWeek() && 6 !== w.dayOfWeek() || this.J(j, "weekend"), j.style.position = "absolute", j.style.left = _ * this.cellWidth + "px", j.style.top = M * this.cellHeight + v + "px", j.style.width = this.cellWidth + "px", j.style.height = this.cellHeight + "px", j.style.lineHeight = this.cellHeight + "px";
                      ...
                      j.setAttribute("unselectable", "on"), j.onclick = this.B, j.onmousedown = this.K, j.onmousemove = this.V, x && (n.q(y, _, M), this.selected.push(j)), y.appendChild(j)
                  }
              }
  ...
  ! function(t) {
      if (!t.Table) {
          var e = function(t) {
              for (var e in this.form = null, this.item = null, this.data = null, this.name = null, this.theme = "edit_table_default", this.onInput = null, this.nav = {}, this.vt = null, this.gt = [], t = t || {}) this[e] = t[e]
          };
          e.prototype.create = function() {
              var t = this,
              ...
              return d.className = this.theme + "_plus", d.addEventListener("click", (function(e) {
                  if (!t.disabled) {
                      ...
                      if ("function" == typeof i) {
                          var a = {};
                          a.result = t.form.serialize(), a.value = {}, i(a), n = a.value
                      }
                      var r = t.pt(n);
                      t.gt.push(r), t.It(), t.Mt()
                  }
              })), this.nav.plus = d, m.appendChild(d), e.appendChild(m), e
          }, e.prototype.bt = function() {
              var t = this,
                  e = document.createElement("div");
              return e.classList.add(this.theme + "_row"), e.classList.add(this.theme + "_header"), this.item.columns.forEach((function(i) {
                  var n = document.createElement("div");
              ...
              this.data = t, this.xt(), this.It()
          }, e.prototype.Nt = function() {
              this.disabled ? this.nav.main.classList.add(this.theme + "_disabled") : this.nav.main.classList.remove(this.theme + "_disabled"), this.wt() ? this.nav.plus.classList.add(this.theme + "_plus_max") : this.nav.plus.classList.remove(this.theme + "_plus_max")
              ...
              var e = this,
                  i = {};
              return i.data = t, i.cells = [], e.item.columns.forEach((function(n) {
                  var a = n.id,
                      r = t[a],
                      o = e.Ct(n);
                  if (void 0 === r)
              ...
              if ("text" === i || "number" === i) {
                  ...
                  return n.type = i, e.disabled && (n.disabled = !0), t.value && (n.value = t.value), n.addEventListener("keyup", (function(n) {
                      t.value = "number" === i ? Number(this.value) : this.value, e.Mt()
                  })), n
              }
              if ("select" === i) {
                  var a = document.createElement("select");
                  return e.disabled && (a.disabled = !0), t.data.options.forEach((function(e) {
                      var i = document.createElement("option");
                      i.innerText = e.name, i.value = e.id, i.kt = e.id, a.appendChild(i), t.value === e.id && i.setAttribute("selected", !0)
                  })), a.addEventListener("change", (function(i) {
                      var n = a.options[a.selectedIndex];
                      n && void 0 !== n.kt && (t.value = n.kt), e.Mt()
                  })), a
              }
  ...
  ! function(t) {
      if (!t.Form) {
          var e = function(t) {
              for (var e in this.form = [], this.data = {}, this.theme = "form_default", this.zIndex = 99999, this.locale = "en-us", this.plugins = {}, this.onKey = null, this.gt = [], this.Ht = null, this.canceling = !1, this.Dt = [], this.Tt = [], this.Pt = null, t = t || {}) this[e] = t[e]
          };
          e.prototype.create = function() {
              return this.load(), this.render(), this.Pt
          }, e.prototype.render = function() {
              var t = this;
              this.Pt = document.createElement("div"), this.gt.forEach((function(e) {
                  t.createView(e)
              })), this.applyState()
              ...
              r.onInput = function(t) {
                  if (t = t || {}, i.zt(r, {
                      ...
                      var e = {};
                      e.result = i.serialize(), i.onChange(e)
                  }
              }, r.onBlur = function() {
                  i.canceling || i.zt(r)
              }, r.apply(t), r.Pt = n, r.row = t, r.element && n.appendChild(r.element), this.Tt.push(r), this.Pt.appendChild(n)
              ...
              if (u) {
                  ...
                  m.value = t.save()[a.field], m.message = "Error", m.values = this.serialize(), m.result = this.serialize(), u(m);
                  var d = this.theme + "_form_item_invalid",
                      h = this.theme + "_form_item_invalid_message";
                  if (m.valid) clearTimeout(this.Dt[a.field]), t.Zt && (t.Zt.remove(), t.Zt = null), t.Pt.classList.remove(d);
                  else {
                      function c() {
                          t.Zt && (t.Zt.remove(), t.Zt = null), t.Pt.classList.add(d);
                          var e = document.createElement("div");
                          e.classList.add(h), e.innerText = m.message, t.Zt = e, t.Pt.appendChild(e)
                      }
                      if (!n)
                          if (i) {
                              clearTimeout(this.Dt[a.field]), this.Dt[a.field] = setTimeout((function() {
                                  c()
                              }), 1e3)
                          } else c()
                  }
              ...
              var i = this,
                  r = {
                      ...
                      text: function() {
                          ...
                          return a.name = e.field, a.type = "text", a.autocomplete = "off", a.onkeydown = function(t) {
                              var e = !1;
                              switch (t.keyCode) {
                                  case 13:
                                      i.doOnKey("Enter");
                      ...
                      textarea: function() {
                          ...
                          return a.name = e.field, e.data.height && (a.style.height = e.data.height + "px"), a.onkeydown = function(t) {
                              ...
                              switch (t.keyCode) {
                                  case 13:
                                      (t.ctrlKey || t.metaKey) && i.doOnKey("Enter"), e = !1;
                                      break;
                                  case 27:
                                      i.doOnKey("Escape");
                                      break;
                      ...
                      select: function() {
                          ...
                          return i.name = e.field, e.data.options && e.data.options.forEach && e.data.options.forEach((function(t) {
                              ...
                              e.innerText = t.name || t.id, e.value = t.id, e.kt = t.id, i.appendChild(e)
                      ...
                      radio: function() {
                          ...
                          r.type = "radio", r.name = e.field, r.kt = e.resolved, r.onchange = function(e) {
                              var n = t.row;
                      ...
                      checkbox: function() {
                          ...
                          var a = document.createElement("label"),
                              r = document.createElement("input");
                          r.type = "checkbox", r.name = e.field, r.kt = e.resolved, r.onchange = function(e) {
                              var n = t.row;
                              i.updateState(n, {
                      ...
                      table: function() {
                          ...
                          t.apply = function(e) {
                              t.row = e;
                              var i = t.table;
                              i.disabled = !e.enabled, i.load(e.value || [])
                          };
                          var a = new f({
                                  name: e.field,
                                  form: i,
              ...
              var t = this;
              (this.updateDependentState(), this.Ht) && (this.Ht.filter((function(e, i) {
                  return t.gt[i] !== e
              })).forEach((function(e) {
                  t.updateInteractive(e)
              })), this.gt = this.Ht, this.Ht = null)
  ...
  ! function(t) {
      if (!t.ModalStatic) {
          ...
          e.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"), e.add(".modal_default_main:focus", "outline: none;"), e.add(".modal_default_content", "padding: 10px 0px;"), e.add(".modal_default_inner", "padding: 20px;"), e.add(".modal_default_input", "padding: 10px 0px;"), e.add(".modal_default_buttons", "margin-top: 10px;"), e.add(".modal_default_buttons", "padding: 10px 0px;"), e.add(".modal_default_form_item", "padding: 10px 0px; position: relative;"), e.add(".modal_default_form_item_level1", "border-left: 2px solid #ccc; margin-left: 10px; padding-left: 20px;"), e.add(".modal_default_form_item.modal_default_form_title", "font-size: 1.5rem; font-weight: bold;"), e.add(".modal_default_form_item input[type=text]", "width: 100%; box-sizing: border-box;"), e.add(".modal_default_form_item textarea", "width: 100%; height: 200px; box-sizing: border-box;"), e.add(".modal_default_form_item input[type=select]", "width: 100%; box-sizing: border-box;"), e.add(".modal_default_form_item label", "display: block;"), e.add(".modal_default_form_item select", "width: 100%; box-sizing: border-box;"), e.add(".modal_default_form_item_label", "margin: 2px 0px;"), e.add(".modal_default_form_item_image img", "max-width: 100%; height: auto;"), e.add(".modal_default_form_item_invalid", ""), e.add(".modal_default_form_item_invalid_message", "position: absolute; right: 0px; top: 9px; background-color: red; color: #ffffff; padding: 2px; border-radius: 2px;"), e.add(".modal_default_background", "opacity: 0.5; background-color: #000;"), e.add(".modal_default_ok", "padding: 3px; width: 80px;"), e.add(".modal_default_cancel", "padding: 3px; width: 80px;"), e.add(".modal_default_form_item_date", "position: relative;"), e.add(".modal_default_form_item_date:after", "content: ''; position: absolute; right: 7px; top: 50%; margin-top: 3px; width: 10px; height: 15px; background-image:url(data:image/svg+xml;base64,)"), -1 !== navigator.userAgent.indexOf("Edge") && e.add(".modal_default_form_item_date input::-ms-clear", "display: none;"), e.add(".modal_default_form_item_scrollable_scroll", "width: 100%; height: 200px; box-sizing: border-box; border: 1px solid #ccc; overflow-y: auto;"), e.add(".modal_default_form_item_scrollable_scroll_content", "padding: 5px;"), e.add(".modal_default_form_item_searchable", "position: relative;"), e.add(".modal_default_form_item_searchable_icon", ""), e.add(".modal_default_form_item_searchable_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(data:image/svg+xml;base64,);"), e.add(".modal_default_form_item_searchable_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"), e.add(".modal_default_form_item_searchable_list_item", "background: white; padding: 2px; cursor: default;"), e.add(".modal_default_form_item_searchable_list_item_highlight", "background: #ccc;"), e.add(".modal_default_form_item_tabular_main", "margin-top: 10px;"), e.add(".modal_default_form_item_tabular_table", "display: table; width: 100%; xbackground-color: #fff; border-collapse: collapse;"), e.add(".modal_default_form_item_tabular_tbody", "display: table-row-group;"), e.add(".modal_default_form_item_tabular_row", "display: table-row;"), e.add(".modal_default_form_item_tabular_row.modal_default_form_item_tabular_header", ""), e.add(".modal_default_form_item_tabular_cell.modal_default_form_item_tabular_rowaction", "padding: 0px; width: 23px;"), e.add(".modal_default_form_item_tabular_cell", "display: table-cell; border: 0px; padding: 2px 2px 2px 0px; cursor: default; vertical-align: bottom;"), e.add(".modal_default_form_item_tabular_header .modal_default_form_item_tabular_cell", "padding-left: 0px; padding-bottom: 0px;"), e.add(".modal_default_form_item_tabular_table input[type=text], .modal_default_form_item_tabular_table input[type=number]", "width:100%; box-sizing: border-box;"), e.add(".modal_default_form_item_tabular_table select", "width:100%; height:100%; box-sizing: border-box;"), e.add(".modal_default_form_item_tabular_plus", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), e.add(".modal_default_form_item_tabular_plus:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"), e.add(".modal_default_form_item_tabular_delete", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), e.add(".modal_default_form_item_tabular_delete:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"), e.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_plus", "display: none;"), e.add(".modal_default_form_item_tabular_plus_max.modal_default_form_item_tabular_plus", "display: none;"), e.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_delete", "visibility: hidden;"), e.add(".modal_default_form_item_tabular_empty", "height: 1px; margin: 5px 23px 5px 0px; background-color: #ccc;"), e.add(".modal_default_form_item_tabular_spacer .modal_default_form_item_tabular_cell", "padding: 0px;"), e.add(".modal_min_main", "border: 1px solid #ccc; max-width: 90%;"), e.add(".modal_min_background", "opacity: 0.5; background-color: #000;"), e.add(".modal_min_ok", "padding: 3px 10px;"), e.add(".modal_min_cancel", "padding: 3px 10px;"), e.add(".navigator_modal_main", "border-left: 1px solid #c0c0c0;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;background-color: white;color: #000000; box-sizing: content-box;"), e.add(".navigator_modal_main *, .navigator_modal_main *:before, .navigator_modal_main *:after", "box-sizing: content-box;"), e.add(".navigator_modal_month", "font-size: 11px;"), e.add(".navigator_modal_day", "color: black;"), e.add(".navigator_modal_weekend", "background-color: #f0f0f0;"), e.add(".navigator_modal_dayheader", "color: black;"), e.add(".navigator_modal_line", "border-bottom: 1px solid #c0c0c0;"), e.add(".navigator_modal_dayother", "color: gray;"), e.add(".navigator_modal_todaybox", "border: 1px solid red;"), e.add(".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright", "border-top: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;color: #333;background: #f3f3f3;"), e.add(".navigator_modal_busy", "font-weight: bold;"), e.add(".navigator_modal_cell", "text-align: center;"), e.add(".navigator_modal_select .navigator_modal_cell_box", "background-color: #FFE794; opacity: 0.5;"), e.add(".navigator_modal_title", "text-align: center;"), e.add(".navigator_modal_titleleft, .navigator_modal_titleright", "text-align: center;"), e.add(".navigator_modal_dayheader", "text-align: center;"), e.add(".navigator_modal_weeknumber", "text-align: center;"), e.add(".navigator_modal_cell_text", "cursor: pointer;"), e.commit(), t.Modal = function(e) {
              ...
              var i = this;
              this.id = "_" + (new Date).getTime() + "n" + 10 * Math.random(), this.Ot = !1, this.Jt = null, this.Wt = null, this.showHtml = function(e) {
                  if (t.ModalStatic.displayed(this)) throw "This modal dialog is already displayed.";
                  if (this.div || this.Ft(), this.Yt(), this.useIframe) {
                  ...
                  var i, n;
                  this.Yt(), this.Rt(), this.Lt()
              }, this.showUrl = function(e) {
                  if (t.ModalStatic.displayed(this)) throw "This modal dialog is already displayed.";
                  if (this.useIframe) {
                      this.div || this.Ft();
                      var n = this.loadingHtml;
                      n && (this.iframe.src = "about:blank", this.setInnerHTML(this.id + "iframe", n)), this.re(this.iframe, "load", this.Gt), this.iframe.src = e, this.Yt(), this.Rt(), this.Lt()
                  } else i.Ut({
                      url: e,
                      success: function(t) {
                  ...
                  if ("function" == typeof i.onShow) {
                      var t = {};
                      t.root = i.Et(), t.modal = i, i.onShow(t)
                  }
              }, this.Et = function() {
                  ...
                  }), 500), this.theme ? this.div.className = this.theme + "_main" : this.div.className = "", this.className && (this.div.className += " " + this.className), this.left ? this.div.style.left = this.left + "px" : this.div.style.marginLeft = "-" + Math.floor(this.width / 2) + "px", this.div.style.position = "absolute", this.div.style.boxSizing = "content-box", this.div.style.top = a + this.top + "px", this.div.style.width = this.width + "px", this.zIndex && (this.div.style.zIndex = this.zIndex), this.height && (this.useIframe || !this.autoStretch ? this.div.style.height = this.height + "px" : this.div.style.height = ""), this.useIframe && this.height && (this.iframe.style.height = this.height + "px"), this.div.style.display = "", this.Xt(), t.ModalStatic.remove(this), t.ModalStatic.list.push(this)
              }, this.Gt = function() {
                  i.iframe.contentWindow.modal = i, i.autoStretch && i.stretch()
              }, this.stretch = function() {
                  if (this.useIframe) {
                      for (var t = i.Qt().x - 40, e = this.width; e < t && this.Bt(); e += 10) this.div.style.width = e + "px", this.div.style.marginLeft = "-" + Math.floor(e / 2) + "px";
                      for (var n = this.maxHeight || i.Qt().y - 2 * this.top, a = this.height; a < n && this.Kt(); a += 10) this.iframe.style.height = a + "px", this.div.style.height = a + "px";
                      this.autoStretchFirstLoadOnly && this.ue(this.iframe, "load", this.Gt)
                  ...
                  this.Ot || (this.re(window, "resize", this.Vt), this.re(window, "scroll", this.qt), this.dragDrop && (this.re(document, "mousemove", this.$t), this.re(document, "mouseup", this.te)), this.Ot = !0)
              }, this.ee = function() {
                  this.ue(window, "resize", this.Vt), this.ue(window, "scroll", this.qt), this.dragDrop && (this.ue(document, "mousemove", this.$t), this.ue(document, "mouseup", this.te)), this.Ot = !1
              }, this.ie = function(t) {
                  t.target === i.div && (t.preventDefault(), i.div.style.cursor = "move", i.ne(), i.Wt = i.mc(t || window.event), i.Jt = {
                      x: i.div.offsetLeft,
                      y: i.div.offsetTop
                  })
              }, this.$t = function(t) {
                  if (i.Wt) {
                      ...
                      var e = i.mc(t),
                          n = e.x - i.Wt.x,
                          a = e.y - i.Wt.y;
                      i.div.style.marginLeft = "0px", i.div.style.top = i.Jt.y + a + "px", i.div.style.left = i.Jt.x + n + "px"
                  }
              }, this.te = function(t) {
                  i.Wt && (i.ae(), i.div.style.cursor = null, i.Wt = null)
              }, this.ne = function() {
                  if (this.useIframe) {
                      var t = document.createElement("div");
              ...
              }, this.se = {}, this.se.container = function() {
                  return i.container || document.body
              }, this.se.scrollY = function() {
                  var t = i.se.container();
                  ...
                  var a = document.createElement("div");
                  a.id = this.id + "popup", a.style.position = e, a.style.left = "50%", a.style.top = "0px", a.style.backgroundColor = "white", a.style.width = "50px", a.style.height = "50px", this.dragDrop && (a.onmousedown = this.ie), a.addEventListener("keydown", (function(t) {
                      t.stopPropagation()
                  }));
                  var r = null;
                  ...
                  a.document && (a = a.document), null == a.body && a.write("<body></body>"), e.nodeType ? a.body.appendChild(e) : a.body.innerHTML = e, i.autoStretch && (i.autoStretchFirstLoadOnly && i.me || (i.stretch(), i.me = !0))
              }, this.close = function(t) {
                  this.result = t, this.hide()
              }, this.closeSerialized = function() {
                  for (var t = i.Et().querySelectorAll("input, textarea, select"), e = {}, n = 0; n < t.length; n++) {
                      var a = t[n],
                          r = a.name;
                      if (r) {
                          var o = a.value;
          ...
          t.Modal.form = function(e, a, r) {
              ...
              return t.getPromise((function(i, r) {
                  ...
                  y.innerText = h, y.className = o.theme + "_ok", d.okDisabled && (y.disabled = !0), y.onclick = function(t) {
                      m.validate() && o.close(m.serialize())
                  };
          ...
          }, t.Modal.Experimental = {}, t.Modal.Experimental.Form = v, void 0 === t.getPromise && (t.getPromise = function(e) {
      ...
      function n(t, e, i) {
          ...
          } else "__proto__" !== e && "constructor" !== e && (t[e] = i)
      }
  }(g);
  const {
      Modal: b
